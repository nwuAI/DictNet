...
class VGGFace2Dataset(Dataset):
    def __init__(self, K, image_size, scale, trans_scale=0, isTemporal=False, isEval=False, isSingle=False):
        ...
        self.imagefolder = '/mnt/f/Data_Set/VGGFaceDataset/vgg_face_dataset/images'
        self.kptfolder = '/mnt/f/Data_Set/VGGFaceDataset/vgg_face_dataset/landmarks'
        self.segfolder = '/mnt/f/Data_Set/VGGFaceDataset/vgg_face_dataset/segment'
        # hq:
        ...
        datafile = '/home/pc/code/DECA/decalib/datasets/VGGFace2/vggface2_train_list_max_normal_100_ring_5_1_serial.npy'
        if isEval:
            datafile = '/ps/scratch/face2d3d/texture_in_the_wild_code/VGGFace2_cleaning_codes' \
                       '/ringnetpp_training_lists/second_cleaning/vggface2_train_list_max_normal_100_ring_5_1_serial' \
                       '.npy '
