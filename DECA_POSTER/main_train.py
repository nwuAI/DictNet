...
os.environ['PATH'] += ':/home/pc/miniconda3/envs/deca_poster/bin:/home/pc/miniconda3/condabin'
...
def main(cfg):
    ...
    deca = DECA(cfg)
    poster = PosterTool(cfg)
    trainer = Trainer(model=deca, exp_model=poster, config=cfg)
